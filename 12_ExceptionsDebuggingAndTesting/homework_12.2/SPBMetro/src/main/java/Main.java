...
public class Main {
    ...
    private static Station takeStation(String message) {
        for (; ; ) {
            ...
            if (message.contains( "отправления" )) {
                logger.info( "The user inputs departure Station "+line );
            } else { logger.info( "The user inputs destination Station "+line );}
            if (station != null) {
                return station;
            }
            if (message.contains( "отправления" )) {
                logger.error( "ERROR!!! The departure station didn't found!!! Line: " + line );
            } else {logger.error( "ERROR!!! The destination station didn't found!!! Line: " + line );}
    ...
    private static String getJsonFile() {
        ...
        try {
            ...
            ex.printStackTrace();
            logger.warn( "Exception error of appending file!!! Reason: "+ex.getMessage());
        }
