...
public class Employee {
    ...
    //// Можно заместо геттера и сеттера просто указать аннотацию
    @Getter
    @Setter
  private String name;
...
//  }
  ...
  //// Комментируем геттер и сеттер имени
...
//  }
  ...
  //// Можно в самом сеттере сразу с помощью Lombok задать условие на исключение NullPointerExeption
  public void setSalary(@NonNull Integer salary) {
    this.salary = salary;
  }
  ...
  //// Заместо этого метода, можно просто указать аннотацию  Lombok @ToString
